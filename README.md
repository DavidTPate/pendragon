...
- [Traits](#traits)
  ...
  - [Rolling for Traits](#rolling-for-traits)
- [Passions](#passions)
  - [Famous Traits and Passions](#famous-traits-and-passions)
...
result of increases made during the Winter Phase (or perhaps by Gamemaster ﬁat). Such characters always have a value of
...
## Rolling for Traits
During play, character behavior is often challenged by the Gamemaster. Temptations are paraded forth, moral crises
heaped up, and critical judgments and actions thrown forward.

Since traits and passions deﬁne character personality, they must be consulted whenever the Gamemaster feels them
...
(❏) near it. This box is checked (✓) when the character gains signiﬁcant experience during an adventure with a skill,
